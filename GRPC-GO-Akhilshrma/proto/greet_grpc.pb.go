...
const (
	...
	GreetService_BiDstreaming_FullMethodName            = "/greet_service.GreetService/BiDstreaming"
)
...
type GreetServiceClient interface {
	...
	SayHello(ctx context.Context, in *NoParameters, opts ...grpc.CallOption) (*HelloResponse, error)
	...
	BiDstreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParameters, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (c *greetServiceClient) BiDstreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_BiDstreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDstreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreetServiceServer interface {
	// Unary RPC: Client sends a request, server responds with a message
	SayHello(context.Context, *NoParameters) (*HelloResponse, error)
	// Server Streaming: Server sends multiple responses for a single request
	...
	// Bi-directional Streaming: Both client and server stream messages
	BiDstreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParameters) (*HelloResponse, error) {
...
func (UnimplementedGreetServiceServer) BiDstreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method BiDstreaming not implemented")
}
...
func _GreetService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SayHello(ctx, req.(*NoParameters))
	}
...
func _GreetService_BiDstreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).BiDstreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_BiDstreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BiDstreaming",
			Handler:       _GreetService_BiDstreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
